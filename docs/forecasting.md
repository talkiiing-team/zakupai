## Документация к модулю прогнозирования расходов на основные средства (forecasting.py)

Этот модуль предназначен для выполнения прогнозирования временных рядов с использованием модели SARIMAX (Сезонная авторегрессионная интегрированная модель скользящего среднего с экзогенными регрессорами). Скрипт включает функции для загрузки данных, подготовки данных и выполнения прогнозов.
