...
RUN apk add --no-cache python3 py3-pip py3-scikit-learn py3-numpy py3-pandas py3-openpyxl py3-matplotlib py3-statsmodels py3-tqdm wget fuse gcc rust cargo
