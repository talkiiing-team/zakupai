...
export type MultiplyWithCoefActionData = {
    type: 'mul_with_coef';
    x: number;
};
...
type Props = {
    id: string;
    data: MultiplyWithCoefActionData;
};

export const MultiplyWithCoefActionNode: FC<Props> = ({ id, data }) => {
    ...
    return (
        <BaseNode
            title="Умножить на распределение характеристики с коэффицентом X"
            color="gray"
