        ...
        return (
            <div className="flex h-full w-full flex-col">
                <main className="flex flex-grow flex-col items-center bg-gradient-to-br from-green-500 to-green-50 text-zinc-800">
                    <div className="mb-24 mt-36 flex flex-col items-center">
                        <h1 className="mb-12 text-8xl">
                            <span className="align-middle">РаспределAI</span>
                        </h1>
                        <p className="max-w-96 text-center text-2xl">
                            AI-система для интеллектуальной аналитики и
                            предсказаний распределенных затрат
                        </p>
                    </div>
                    <div>
                        <button
                            className="flex transform items-center justify-center rounded-xl border border-zinc-300 bg-white px-24 py-3 text-2xl shadow-2xl transition duration-150 hover:scale-110 hover:text-green-500"
                            onClick={() => navigate({ to: '/processings' })}
                        >
                            Начать!
                        </button>
                    </div>
